...
export async function GET(request: any) {
  ...
  try {
    ...
    const trips: any = await axios.get(`${process.env.CURB_SERVER_URL}/trip/list/upcoming/${fleetId}`)
      .then((res) => res.data);

    return helper.createResponse({ trips });
  } catch (e) {
    return helper.createErrorResponse('Failed to retrieve list of upcoming trips', e);
  }
}
